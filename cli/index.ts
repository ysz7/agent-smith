...
async function main(): Promise<void> {
  ...
  const lima = new LimaMemory(path.join(agentSmithHome, 'lima.db'))
  const history = new SqliteHistory(lima.getDb())
  ...
  gateway.setAgentHistoryProvider(async (agentId: string) => {
